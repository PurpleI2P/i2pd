...
namespace spanish // language namespace
{
	...
	static const LocaleStrings strings
	{
		...
		{"Full cone NAT", "NAT de cono completo"},
		{"No Descriptors", "Sin descriptores"},
		...
		{"Total tunnel creation success rate", "Tasa de éxito de creación de túneles"},
		{"Received", "Recibido"},
		{"%.2f KiB/s", "%.2f KiB/s"},
		{"Sent", "Enviado"},
		{"Transit", "Tránsito"},
		...
		{"TunnelID", "TunnelID"},
		{"EndDate", "FechaVenc"},
		{"floodfill mode is disabled", "el modo floodfill está desactivado"},
		{"Queue size", "Tamaño de cola"},
		{"Run peer test", "Ejecutar prueba de par"},
		{"Reload tunnels configuration", "Recargar configuración de túneles"},
		...
		{"You will be redirected in %d seconds", "Serás redirigido en %d segundos"},
		{"LeaseSet expiration time updated", "Tiempo de caducidad de LeaseSet actualizado"},
		{"LeaseSet is not found or already expired", "El LeaseSet no se encuentra o ha expirado"},
		{"Transit tunnels count must not exceed %d", "El número de túneles de tránsito no debe exceder de %d"},
		...
		{"Addresshelper is not supported", "No soporta ayudante de dirección"},
		{"Host %s is <font color=red>already in router's addressbook</font>. <b>Be careful: source of this URL may be harmful!</b> Click here to update record: <a href=\"%s%s%s&update=true\">Continue</a>.", "El dominio %s <font color=red>ya se encuentra en tu libreta</font>. <b>Precaución: ¡la fuente de esta URL puede ser maliciosa!</b> Haga clic aquí para actualizar el dominio: <a href=\"%s%s%s&update=true\">Continuar</a>."},
		{"Addresshelper forced update rejected", "Actualización forzada de ayudante de dirección rechazada"},
		{"To add host <b>%s</b> in router's addressbook, click here: <a href=\"%s%s%s\">Continue</a>.", "Para agregar el dominio <b>%s</b> en la libreta de su enrutador, haga clic aquí: <a href=\"%s%s%s\">Continuar</a>."},
		{"Addresshelper request", "Pedido de ayudante de dirección"},
		{"Host %s added to router's addressbook from helper. Click here to proceed: <a href=\"%s\">Continue</a>.", "Dominio %s agregado a la libreta del enrutador. Haga clic aquí para continuar: <a href=\"%s\">Continuar</a>."},
		{"Addresshelper adding", "Agregando ayudante de dirección"},
		{"Host %s is <font color=red>already in router's addressbook</font>. Click here to update record: <a href=\"%s%s%s&update=true\">Continue</a>.", "El dominio %s <font color=red>ya se encuentra en tu libreta</font>. Haga clic aquí para actualizar el dominio: <a href=\"%s%s%s&update=true\">Continuar</a>."},
		{"Addresshelper update", "Actualizando ayudante de dirección"},
