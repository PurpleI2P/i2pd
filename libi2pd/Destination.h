...
namespace client
{
		...
		public std::enable_shared_from_this<LeaseSetDestination>
	{
		...
		protected:
			...
			void UpdateLeaseSet (); // rebuild + republish the local LeaseSet from the current tunnels
	...
	class ClientDestination: public LeaseSetDestination
	{
		public:
			...
			void UpdateOfflineSignature (const i2p::data::PrivateKeys& keys); // adopt a refreshed offline transient in place
